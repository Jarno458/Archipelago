...
class Items:
    item_data: ClassVar[Dict[str, ItemData]] = {
        ...
        "Recipe: Encased Uranium Cell": ItemData((G.Recipe, ), 1338340, C.progression),
        ...
        #"Recipe: Mycelia": ItemData((G.Recipe, ), 1338376),
        ...
        "Building: Priority Power Switch": ItemData((G.Building, ), 1338635, C.useful),
        ...
        "Building: Storage Container": ItemData((G.Building, ), 1338640, C.filler),
        ...
        "Building: Metal Beams": ItemData((G.Beams, ), 1338623, C.filler),
        ...
        "Building: Power Tower Platform": ItemData((G.Building, ), 1338674, C.useful),
        ...
        "Building: Label Sign Bundle": ItemData((G.Building, G.Signs), 1338678, C.filler),
        "Building: Display Sign Bundle": ItemData((G.Building, G.Signs), 1338679, C.filler),
        "Building: Billboard Set": ItemData((G.Building, G.Signs), 1338680, C.filler),
        "Building: Small Pillar Support": ItemData((G.Pilars, ), 1338681, C.filler),
        "Building: Small Metal Pillar": ItemData((G.Pilars, ), 1338682, C.filler),
        "Building: Small Concrete Pillar": ItemData((G.Pilars, ), 1338683, C.filler),
        "Building: Small Frame Pillar": ItemData((G.Pilars, ), 1338684, C.filler),
        "Building: Big Pillar Support": ItemData((G.Pilars, ), 1338685, C.filler),
        "Building: Big Metal Pillar": ItemData((G.Pilars, ), 1338686, C.filler),
        "Building: Big Concrete Pillar": ItemData((G.Pilars, ), 1338687, C.filler),
        "Building: Big Frame Pillar": ItemData((G.Pilars, ), 1338688, C.filler),
