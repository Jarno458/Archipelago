...
class Items:
    item_data: ClassVar[Dict[str, ItemData]] = {
        ...
        "Recipe: Diluted Fuel (blender)": ItemData("Recipe", 1338306, type=ItemClassification.progression),
        ...
        "Recipe: Sulfuric Acid": ItemData("Recipe", 1338338, type=ItemClassification.progression),
        ...
        "Recipe: Infused Uranium Cell": ItemData("Recipe", 1338341, type=ItemClassification.progression),
        "Recipe: Uranium Fuel Rod": ItemData("Recipe", 1338342, type=ItemClassification.progression),
        "Recipe: Uranium Fuel Unit": ItemData("Recipe", 1338343, type=ItemClassification.progression),
        "Recipe: Beacon": ItemData("Recipe", 1338344, type=ItemClassification.progression),
        "Recipe: Crystal Beacon": ItemData("Recipe", 1338345, type=ItemClassification.progression),
        "Recipe: Uranium Waste": ItemData("Recipe", 1338346, type=ItemClassification.progression),
        "Recipe: Non-fissile Uranium": ItemData("Recipe", 1338347, type=ItemClassification.progression),
        "Recipe: Fertile Uranium": ItemData("Recipe", 1338348, type=ItemClassification.progression),
        "Recipe: Plutonium Pellet": ItemData("Recipe", 1338349, type=ItemClassification.progression),
        "Recipe: Encased Plutonium Cell": ItemData("Recipe", 1338350, type=ItemClassification.progression),
        "Recipe: Instant Plutonium Cell": ItemData("Recipe", 1338351, type=ItemClassification.progression),
        "Recipe: Plutonium Fuel Rod": ItemData("Recipe", 1338352, type=ItemClassification.progression),
        "Recipe: Plutonium Fuel Unit": ItemData("Recipe", 1338353, type=ItemClassification.progression),
        "Recipe: Gas Filter": ItemData("Recipe", 1338354, type=ItemClassification.progression),
        "Recipe: Iodine Infused Filter": ItemData("Recipe", 1338355, type=ItemClassification.progression),
        "Recipe: Assembly Director System": ItemData("Recipe", 1338356, type=ItemClassification.progression),
        "Recipe: Magnetic Field Generator": ItemData("Recipe", 1338357, type=ItemClassification.progression),
        "Recipe: Copper Powder": ItemData("Recipe", 1338358, type=ItemClassification.progression),
        "Recipe: Nuclear Pasta": ItemData("Recipe", 1338359, type=ItemClassification.progression),
        "Recipe: Thermal Propulsion Rocket": ItemData("Recipe", 1338360, type=ItemClassification.progression),
        ###
