...
class Items:
    item_data: ClassVar[Dict[str, ItemData]] = {
        ...
        "Bundle: Beacon": ItemData((G.Parts, ), 1338014),
        ...
        "Bundle: Color Cartridge": ItemData((G.Parts, ), 1338022),
        ...
        "Bundle: Plutonium Waste (item)": ItemData((G.Trap, ), 1338080, C.trap),
        ...
        "Bundle: Quantum Computer": ItemData((G.Parts, ), 1338085),
        ...
        "Bundle: SAM Ore": ItemData((G.Parts, ), 1338093),
        ...
        "Bundle: Uranium Waste (item)": ItemData((G.Trap, ), 1338113, C.trap),
        ...
        "Bundle: Gas Mask": ItemData((G.Equipment, ), 1338162, C.progression),
        "Bundle: Gas Nobelisk": ItemData((G.Ammo, ), 1338163),
        "Bundle: Hazmat Suit": ItemData((G.Equipment, ), 1338164, C.progression),
        "Bundle: Homing Rifle Ammo": ItemData((G.Ammo, ), 1338165),
        "Bundle: Hover Pack": ItemData((G.Equipment, ), 1338166, C.progression),
        "Bundle: Iron Rebar": ItemData((G.Ammo, ), 1338167),
        "Bundle: Jetpack": ItemData((G.Equipment, ), 1338168, C.progression),
        "Bundle: Medicinal Inhaler": ItemData((G.Ammo, ), 1338169),
        "Bundle: Nobelisk": ItemData((G.Ammo, ), 1338170),
        "Bundle: Nobelisk Detonator": ItemData((G.Equipment, ), 1338171, C.progression),
        ...
        #"Obtainable: Leaves": ItemData((G.Recipe, ), 1338362), 
        #"Obtainable: Wood": ItemData((G.Recipe, ), 1338363), 
        #"Obtainable: Hatcher Remains": ItemData((G.Recipe, ), 1338364), 
        #"Obtainable: Hog Remains": ItemData((G.Recipe, ), 1338365), 
        #"Obtainable: Plasma Spitter Remains": ItemData((G.Recipe", 1338366),
